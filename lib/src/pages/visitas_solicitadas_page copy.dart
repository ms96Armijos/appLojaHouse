...
class _VisitasSolicitadasArrPageState extends State<VisitasSolicitadasArrPage> {
  ...
  eliminarVisitaEstado(BuildContext context,
    ...
    final url =
        'http://192.168.1.4:3000/visita/eliminarvisita/${listadoVisitasSolicitadas[index][index]['_id']}?token=${preferenciaToken.token}';
  ...
  obtenerVisitas() async {
    final response = await http.get(
      'http://192.168.1.4:3000/visita/arrendatario/visitasolicitadamovil?token=${preferenciaToken.token}',
      headers: {"Content-Type": "application/json"},
    );
